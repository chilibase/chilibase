...
export function convertObject(entity: string, object: any, fromModel: boolean, asUI: AsUIType | undefined) {
    ...
    for (const [field, value] of Object.entries(object)) {
        ...
        if (xField) {
            ...
            // nenasli sme medzi fieldami, skusime hladat assoc
...
export function convertValue(field: Field, value: any, fromModel: boolean, asUI: AsUIType | undefined): any {
    return convertValueBase(field.type, field.scale, value, fromModel, asUI);
}
