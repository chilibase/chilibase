...
import {CustomFilterItem, ExtendedDataTableFilterMeta, FullTextSearch} from "./FindParam";
...
export interface ExportColumnParam {
    ...
    textFormat?: TextFormat; // for now used only for excel (in future can be used also for csv)
}
