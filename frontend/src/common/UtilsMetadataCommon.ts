import {Assoc, Entity, EntityMap, Field, RelationType} from "./EntityMetadata";
...
export class UtilsMetadataCommon {
    ...
    private static getAssoc(xEntity: Entity, assocField: string, relationTypeList?: RelationType[]): Assoc {
