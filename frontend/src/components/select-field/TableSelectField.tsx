...
export const TableSelectField = (props: {
        form: FormBase;
        entity: string;
        assocField: string;
        displayField: string;
    ...
    useEffect(() => {
        //console.log("TableSelectField - zavolany useEffect *******************")
        findOptions();
    ...
    const findOptions = async () => {
        ...
        if (options === undefined) {
            ...
            //console.log("TableSelectField - findOptions - citali sme options pre field = " + props.assocField);
    ...
    // appendTo={document.body} appenduje overlay panel na element body - eliminuje problem s overflow (pozri poznamku v TableFilterSelectInput)
    return (
